...
// {"name":"Pesho","age":22,"birthday":"1998-01-07T22:00:00.000Z"}
...
describe("repository", function () {
        ...
        it("added entity in the Map", function () {
           assert.equal(repository.add(entity), 2);
           assert.equal(repository.add(entity), 3);
        });

        it('getId', function(){
            assert.equal(repository.getId(1), {"name":"Pesho","age":22,"birthday":"1998-01-07T22:00:00.000Z"});
        });
