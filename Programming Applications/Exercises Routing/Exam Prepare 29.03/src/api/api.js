...
export async function register(username,password){//username,email,password, gender - options
    const result = await post(settings.host + '/users/register', {username,password});//username,email,password, gender - options
