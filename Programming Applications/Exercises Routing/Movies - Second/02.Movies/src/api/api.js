...
export async function register(email,password){//username,email,password, gender - options
    const result = await post(settings.host + '/users/register', {email,password});//username,email,password, gender - options
