...
const homeTemplate = (data,userId) => html`
...
<section id="movie">
    <div class=" mt-3 ">
        <div class="row d-flex d-wrap">
            ...
            <div id="views" class="card-deck d-flex justify-content-center">
...
<div class="card mb-4">
    ...
    <div class="card-footer">
        <a href=${`/details/${item._id}`}> <button type="button" class="btn btn-info">Details</button>
        </a>
    </div>
...
export async function homePage(ctx) {
    ...
    ctx.render(homeTemplate(data,userId));
    ctx.setUserNav();
